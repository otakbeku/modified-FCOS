...
def evaluate_coco(generator, model, threshold=0.05, json_id=1):
    ...
    # write output
    json.dump(results, open(f'coco_bbox_results_{json_id}.json', 'w'), indent=4)
    # json.dump(image_ids, open('{}_processed_image_ids.json'.format(generator.set_name), 'w'), indent=4)

    # load results in COCO evaluation tool
    coco_true = generator.coco
    coco_pred = coco_true.loadRes(f'coco_bbox_results_{json_id}.json')
